...
public class NotEquals extends AbstractInfixOperator {
	...
	public Value<?> evaluate(
		ValueResolver valueResolver, Expression expression, Token operatorToken, Value<?> leftExpression, Value<?> rightExpression) {
