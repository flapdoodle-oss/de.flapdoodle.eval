...
public class Trigonometric extends TypedEvaluatables.Wrapper {

    private Trigonometric(TypedEvaluatables delegate) {
        super(delegate);
    }

    protected abstract static class AbstractTransformation implements TypedEvaluatable.Arg1<Value.NumberValue, Value.NumberValue> {
    ...
    protected abstract static class AbstractMerge implements TypedEvaluatable.Arg2<Value.NumberValue, Value.NumberValue, Value.NumberValue> {
    ...
    private static Trigonometric of(AbstractTransformation transformation, ParameterValidator<Value.NumberValue>... validators) {
        return new Trigonometric(TypedEvaluatables.builder()
                .addList(TypedEvaluatable.of(Value.NumberValue.class, Parameter.of(Value.NumberValue.class)
    ...
    private static Trigonometric of(AbstractMerge transformation) {
        return new Trigonometric(TypedEvaluatables.builder()
                .addList(TypedEvaluatable.of(Value.NumberValue.class, Value.NumberValue.class, Value.NumberValue.class, transformation))
                .build());
    }
